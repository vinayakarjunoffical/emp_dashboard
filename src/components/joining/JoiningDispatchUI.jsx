...
const JoiningDispatchUI = ({ employee }) => {
 ...
 const handleIssueJoining = async () => {
  ...
  return (
    <div className="mt-8 max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      
      {/* STATUS HEADER */}
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-6">
        <div>
          <h2 className="text-2xl font-black text-slate-900 tracking-tight">Onboarding Dispatch Center</h2>
          <p className="text-slate-500 text-sm font-medium">Finalize logistics and issue the formal Joining Letter to the candidate.</p>
        </div>
