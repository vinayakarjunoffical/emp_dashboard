...
//                         <div className="h-10 w-10 rounded-2xl bg-white border border-blue-600 text-blue-600 flex items-center justify-center font-bold text-xs ">
//                           {(inv.name ?? "?").charAt(0)}
//                         </div>
//                         <div>
...
//                           className="p-2.5 !bg-transparent !text-blue-500 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all border border-blue-500 "
//                           title="View Details"
//                         >
//                           <Eye size={16} />
//                         </button>
...
//                           }}
//                           className="p-2.5 !bg-transparent !text-blue-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-xl transition-all border border-slate-100 shadow-sm"
