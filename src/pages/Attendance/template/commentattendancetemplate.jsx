...
//             <h2 className="text-sm font-black !text-black !capitalize  tracking-tight">Template</h2>
//           </div>
//         </div>
//       </div>
...
//               </div>
//              <div className='gap-2'>
//                <h1 className="md:text-2xl text-lg font-black !text-black tracking-tighter !capitalize">Attendance Templates</h1>
...
//                     <h3 className="text-sm font-black text-black-800 capitalize tracking-tight group-hover:text-blue-600 transition-colors">
//                       {item.name}
//                     </h3>
//                     {item.isNew && (
...
//           <div className="flex items-center gap-3">
//             <div className="w-1.5 h-6 bg-blue-600 rounded-full group-hover:h-8 transition-all" />
//             <h3 className="text-[14px] font-black !text-black !capitalize tracking-tight group-hover:text-blue-600 transition-colors">{item.name}</h3>
//           </div>
...
//             <div>
//               <h2 className="text-xl font-black text-black capitalize tracking-tighter">Staff List</h2>
//               <p className="text-[11px] font-bold text-black capitalize tracking-widest mt-1">Check staff assigned and unassigned to this template</p>
//             </div>
...
//                     />
//                   </th>
//                   <th className="text-[9px] font-black text-black capitalize tracking-widest py-3">Name</th>
//                   <th className="text-[9px] font-black text-black capitalize tracking-widest py-3">Staff ID</th>
//                   <th className="text-[9px] font-black text-black capitalize tracking-widest py-3">Base Location</th>
//                 </tr>
//               </thead>
...
//               <div>
//                 <h3 className="text-xl font-black text-black-900 capitalize tracking-tighter">Filter By</h3>
...
//               </div>
//               <div className="space-y-2">
//                 <label className="text-[10px] font-black text-black-400 capitalize tracking-[0.2em] ml-1">Available Shifts</label>
...
//                     <span className="text-[11px] font-black text-black-500 capitalize tracking-wider">Shift Options</span>
//                   </div>
...
//               </div>
//               <div className="space-y-2">
//                 <label className="text-[10px] font-black text-black-400 capitalize tracking-[0.2em] ml-1">Department</label>
//                 <div className="relative">
...
//               <button onClick={() => setIsFilterOpen(false)} className="flex-1 py-4 border-2 border-slate-200 rounded-2xl text-[11px] font-black capitalize tracking-widest text-black-400 hover:bg-white hover:text-black-600 transition-all">Reset</button>
...
//         <div>
//           <h3 className="text-[13px] font-black text-black capitalize tracking-tighter">Filter By</h3>
...
//         {/* <button 
//           onClick={() => setIsFilterOpen(false)}
//           className="flex-1 py-2.5 border border-slate-200 rounded-xl text-[10px] font-black capitalize tracking-widest text-black-400 hover:bg-white hover:text-black-600 transition-all active:scale-95"
//         >
//           Clear Filter
//         </button> */}
//         <button 
...
//         {label}
//       </p>
//       <p className={`text-[10px] font-bold capitalize leading-none ${isLink ? 'text-blue-600 underline cursor-pointer' : 'text-black'}`}>
//         {value}
//       </p>
//     </div>
//   </div>
...
//             <h2 className="text-sm font-black text-black-900 capitalize tracking-tight">Template</h2>
//           </div>
//         </div>
//       </div>
...
//               </div>
//              <div className='gap-2'>
//                <h1 className="text-2xl font-black text-black-900 tracking-tighter capitalize">Attendance Templates</h1>
//               <p className="text-[10px] font-bold text-black-400 capitalize tracking-[0.15em] max-w-md">
//                attendance modes, late entry, attendance on holiday and More.
//             </p>
//              </div>
//             </div>
...
//         {label}
//       </p>
//       <p className={`text-[10px] font-bold capitalize leading-none ${isLink ? 'text-blue-600 underline cursor-pointer' : 'text-black-600'}`}>
//         {value}
//       </p>
//     </div>
//   </div>
