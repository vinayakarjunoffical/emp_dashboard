...
export default function EmployeeDemoDetails2() {
  const { id } = useParams();
...
const formatRegistryDate = (dateString) => {
  ...
  return (
    <div className="p-8 bg-slate-50 min-h-screen space-y-6">
      {/* Horizontal Info Strip Skeleton */}
      <div className="h-20 bg-white border border-slate-100 rounded-2xl flex items-center px-6 space-x-4 animate-pulse">
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-8 space-y-6">
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm relative overflow-hidden animate-pulse">
            ...
            <User size={80} className="absolute -bottom-6 -right-6 opacity-5 text-slate-900" />
          </div>
        </div>
        ...
        <div className="border border-slate-200 rounded-xl mb-4 overflow-hidden bg-white shadow-sm">
          ...
          {openVerify === "esign" && (
            <div className="p-6 bg-slate-50/40 border-t">
              {console.log("ssssss esignstatus", isEsignSigned)}
