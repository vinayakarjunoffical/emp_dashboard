...
import { 
  ...
  Coins, MinusCircle, MoreVertical, Info // 🚀 Added missing icons for Step 4
} from "lucide-react";
      ...
      <div className="mx-6 p-6 md:p-8 rounded-xl border border-slate-100 shadow-sm bg-white">
        ...
        <form onSubmit={currentStep === 4 ? handleSubmit : nextStep} className="space-y-8">
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-10">
              <section className="space-y-4 mb-4">
                <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
                   <div className="w-7 h-7 rounded-lg border border-blue-500 bg-white flex items-center justify-center text-blue-500 shadow-sm shadow-blue-100"><User size={14} /></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <FormInput label="Role" name="role" value={formData.role} onChange={handleChange} icon={<Briefcase className={iconStyle}/>} required placeholder="Senior Lead" />
                  <FormInput label="Joining Date" name="joining_date" type="date" value={formData.joining_date} onChange={handleChange} icon={<CalendarDays className={iconStyle}/>} required />
              ...
              <section className="space-y-4 mb-4">
                <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
                   <div className="w-7 h-7 rounded-lg bg-white border border-blue-500 flex items-center justify-center text-blue-500 shadow-sm"><MapPin size={14} /></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="space-y-1 group">
                    ...
                    <div className="relative">
                      ...
                      <input name="pincode" maxLength={6} value={formData.pincode} onChange={handleChange} className={`${inputStyle} pl-8 tracking-[0.2em]`} required placeholder="000000" />
                    </div>
                  </div>
              ...
              <section className="space-y-4 pt-4">
                <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
                   <div className="w-7 h-7 rounded-lg bg-white flex items-center justify-center border border-blue-500 text-blue-500 shadow-sm shadow-rose-100"><ShieldAlert size={14} /></div>
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-10">
              ...
              <section className="space-y-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <button type="button" onClick={handleAddEdu} className="flex items-center gap-2 px-6 py-2.5 !bg-white !text-blue-500 text-[11px] font-black uppercase tracking-widest rounded-xl hover:!bg-white transition-all border-2 border-blue-500 active:scale-95 shadow-sm shadow-blue-100 cursor-pointer">
                        ...
                        <div className="flex-1 ml-10 bg-white border border-slate-200 rounded-[1.5rem] p-6 shadow-sm hover:shadow-md transition-all relative overflow-hidden">
                          <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button type="button" onClick={() => handleEditEdu(edu)} className="p-2 !bg-blue-50 !text-blue-500 border-2 border-blue-500 hover:!bg-white hover:!text-white rounded-lg transition-all cursor-pointer">
                                <Edit3 size={14} />
                              </button>
                            </div>
                          </div>
              ...
              {!formData.is_fresher && (
                <section className="space-y-4 pt-4">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                    ...
                    <button type="button" onClick={() => { setDraftExperiences([...draftExperiences, emptyExperience]); setShowExperienceModal(true); }} className="flex items-center gap-2 px-6 py-2.5 !bg-white !text-blue-500 text-[11px] font-black uppercase tracking-widest rounded-xl hover:bg-white border-2 border-blue-500 transition-all active:scale-95 cursor-pointer">
              ...
              <div className="bg-white border border-slate-200 rounded-xl shadow-sm">
                <div className="bg-slate-50/50 px-8 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-t-xl">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <button type="button" onClick={() => setIsModalOpen(true)} className="flex items-center gap-2 !text-blue-600 text-[10px] font-black !bg-transparent uppercase shadow-sm cursor-pointer border px-4 py-3 rounded-xl !border-blue-500 transition-all active:scale-95"><Plus size={14} strokeWidth={3} /> Add More</button>
                  </div>
                </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl shadow-sm">
                <div className="bg-slate-50/50 px-8 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-t-xl">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <button type="button" onClick={() => setIsDeductionModalOpen(true)} className="flex items-center gap-2 !text-blue-600 text-[10px] font-black !bg-transparent uppercase shadow-sm cursor-pointer border px-4 py-3 rounded-xl !border-blue-500 transition-all active:scale-95"><Plus size={14} strokeWidth={3} /> Add More</button>
                  </div>
                </div>
                      ...
                      {item.label === "Professional Tax (PT)" && (
                        <div className="space-y-3 pt-2 pb-4">
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between ml-1 sm:ml-8 gap-3 sm:gap-0 mb-4">
                            <button type="button" className="text-[10px] font-medium !text-blue-500 hover:underline border-0 p-0 !bg-transparent cursor-pointer flex items-center gap-1.5 w-fit">
              ...
              <div className="bg-white border border-slate-200 rounded-xl shadow-sm">
                <div className="bg-slate-50/50 px-8 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-t-xl">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <button type="button" onClick={() => setIsEmployerModalOpen(true)} className="flex items-center gap-2 !text-blue-600 text-[10px] font-black !bg-transparent uppercase shadow-sm cursor-pointer border px-4 py-3 rounded-xl !border-blue-500 transition-all active:scale-95"><Plus size={14} strokeWidth={3} /> Add More</button>
                  </div>
                </div>
                <div className="p-8 space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-slate-100">
            ...
            <button type="submit" disabled={isSubmitting || pincodeLoading} className="flex items-center gap-2 !bg-white hover:!bg-white disabled:!bg-slate-200 !text-blue-500 font-black border border-blue-600 text-[10px] uppercase tracking-[0.1em] px-10 py-2.5 rounded-xl transition-all shadow-sm shadow-blue-100 active:scale-95 cursor-pointer outline-none">
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-3">
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-slate-200 overflow-hidden flex flex-col max-h-[95vh] animate-in zoom-in-95 duration-200">
            ...
            <div className="px-5 py-3 border-t border-slate-100 bg-white flex justify-end gap-2 sticky bottom-0 z-20">
              <button type="button" onClick={saveEducation} className="px-6 py-1.5 !bg-white !text-blue-500 border-2 !border-blue-500 rounded-lg text-[9px] font-black uppercase tracking-widest flex items-center gap-1.5 hover:bg-blue-50 shadow-sm active:scale-95 cursor-pointer">
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-4xl rounded-[2.5rem] shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-300">
            <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-white z-20">
              <div className="flex items-center gap-3">
                <div className="p-2.5 !bg-white !text-blue-500 rounded-xl shadow-sm shadow-blue-200"><Briefcase size={20} strokeWidth={2.5} /></div>
                <div>
                ...
                <div key={index} className="bg-white border border-slate-200 rounded-[2rem] p-8 shadow-sm relative">
                  <div className="flex justify-between items-center mb-8 pb-4 border-b border-slate-50">
                    ...
                    {draftExperiences.length > 1 && (
                      <button type="button" onClick={() => setDraftExperiences(draftExperiences.filter((_, i) => i !== index))} className="text-[10px] !bg-transparent font-black !text-blue-500 uppercase flex items-center gap-1 border-0 cursor-pointer">
            ...
            <div className="px-8 py-5 border-t border-slate-100 bg-slate-50 flex justify-end gap-3 z-20">
              <button type="button" onClick={handleSaveExperience} className="flex items-center border !border-blue-500 gap-2 bg-blue-600 hover:bg-blue-700 !text-white font-black px-10 py-3 rounded-xl shadow-sm shadow-blue-500/20 transition-all active:scale-95 text-[11px] uppercase tracking-[0.15em] cursor-pointer">
                <Save size={16} /> Submit
              </button>
            </div>
          </div>
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[90vh]">
            <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-white z-10">
              <div>
                ...
                <p className="text-[10px] text-blue-500 font-bold uppercase tracking-[0.15em] mt-0.5">System Record : {editForm.company_name}</p>
              </div>
...
const inputStyle = "w-full pl-3 pr-3 py-2.5 bg-white border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all text-[12px] font-bold text-slate-700 disabled:bg-slate-50 disabled:text-slate-400 placeholder:text-slate-200 shadow-sm appearance-none";
const iconStyle = "absolute left-3 top-1/2 -translate-y-1/2 text-slate-300 w-3.5 h-3.5 group-focus-within:text-blue-500 transition-colors pointer-events-none";
...
//   <div className="relative">
//     {pincodeLoading ? (
//       <Loader2 className={`absolute left-2 top-1/2 -translate-y-1/2 ${iconStyle} animate-spin text-blue-500`} />
//     ) : (
...
//               <section className="space-y-4 pt-4">
//                 <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                    <div className="w-7 h-7 rounded-lg bg-white flex items-center justify-center border border-blue-500 text-blue-500 shadow-sm shadow-blue-100"><ShieldAlert size={14} /></div>
//                    <h3 className="text-xs font-black text-slate-900 capitalize tracking-widest">Emergency Details</h3>
//                 </div>
//                 <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
//                   <FormInput label="Contact Name" name="emergency_contact_name" value={formData.emergency_contact_name} onChange={handleChange} icon={<User className={iconStyle}/>} placeholder="Next of Kin" />
...
//               {currentStep === 1 ? "Cancel" : "Previous"}
//             </button>
//             <button type="submit" disabled={isSubmitting || pincodeLoading} className="flex items-center gap-2 !bg-white hover:!bg-slate-50 disabled:!bg-white !text-blue-500 font-black border border-blue-500 text-[10px] uppercase tracking-[0.1em] px-10 py-2.5 rounded-xl transition-all shadow-sm shadow-blue-100 active:scale-95 cursor-pointer">
//               {isSubmitting ? <Loader2 className="animate-spin" size={16} /> : <><Save size={16} /> {currentStep === 4 ? "Finalize Onboarding" : `Proceed to Step ${currentStep + 1}`}</>}
//             </button>
//           </div>
//         </form>
...
//             </div>
//             <div className="px-8 py-5 border-t border-slate-100 bg-slate-50 flex justify-end gap-3 z-20">
//               <button type="button" onClick={handleSaveExperience} className="flex items-center border !border-blue-500 gap-2 !bg-transparent hover:!bg-white !text-blue-600 font-black px-10 py-3 rounded-xl shadow-sm shadow-blue-500/20 transition-all active:scale-95 text-[11px] uppercase tracking-[0.15em] cursor-pointer">
//                 <Save size={16} /> Submit
//               </button>
//             </div>
//           </div>
...
//               <button type="button" onClick={handleUpdateExperience} className="flex items-center gap-2 px-8 !border-blue-500 py-2.5 !bg-white !text-blue-600 text-sm font-bold rounded-xl border transition-all active:scale-[0.98] cursor-pointer">
//                 <Save size={18} /> Update Record
//               </button>
//             </div>
//           </div>
...
//                 <section className="space-y-4">
//                   <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                     <div className="w-7 h-7 rounded-lg border border-blue-500 bg-white flex items-center justify-center text-blue-500"><User size={14} /></div>
//                     <h3 className="text-xs font-black text-slate-900 capitalize tracking-widest">Employee Details</h3>
//                   </div>
//                   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
...
//                 <section className="space-y-4 pt-4">
//                   <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                     <div className="w-7 h-7 rounded-lg border border-blue-500 bg-white flex items-center justify-center text-blue-500"><MapPin size={14} /></div>
//                     <h3 className="text-xs font-black text-slate-900 capitalize tracking-widest">Address Details</h3>
//                   </div>
//                   <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
//                     <div className="space-y-1 group">
...
//                 <section className="space-y-4 pt-4">
//                   <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                     <div className="w-7 h-7 rounded-lg border border-blue-500 bg-white flex items-center justify-center text-blue-500"><ShieldAlert size={14} /></div>
//                     <h3 className="text-xs font-black text-slate-900 capitalize tracking-widest">Emergency Details</h3>
//                   </div>
//                   <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
...
//                 <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                   <div className="w-7 h-7 rounded-lg border border-blue-500 bg-white flex items-center justify-center text-blue-500"><Wallet size={14} /></div>
//                   <h3 className="text-xs font-black text-slate-900 capitalize tracking-widest">Salary & Shift Details</h3>
//                 </div>
...
//               <button type="submit" disabled={isSubmitting || pincodeLoading} className="flex items-center gap-2 !bg-white hover:!bg-white disabled:!bg-white !text-blue-500 font-black border border-blue-500 text-[10px] uppercase tracking-[0.1em] px-10 py-2.5 rounded-xl transition-all shadow-sm shadow-blue-100 active:scale-95">
...
//           <section className="space-y-4">
//             <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                <div className="w-7 h-7 rounded-lg border border-blue-500 bg-white flex items-center justify-center text-blue-500 shadow-sm shadow-blue-100">
//                   <User size={14} />
//                </div>
//                <div>
...
//           <section className="space-y-4">
//             <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                <div className="w-7 h-7 rounded-lg bg-white border border-blue-500 flex items-center justify-center text-blue-500 shadow-sm">
//                   <MapPin size={14} />
//                </div>
//                <div>
//                   <h3 className="text-xs font-black text-slate-900 capitalize tracking-widest">Address Details</h3>
...
//           <section className="space-y-4">
//             <div className="flex items-center gap-3 border-b border-slate-50 pb-2">
//                <div className="w-7 h-7 rounded-lg bg-white flex items-center justify-center border border-blue-500 text-blue-500 shadow-sm shadow-blue-100">
//                   <ShieldAlert size={14} />
//                </div>
//                <div>
//                   <h3 className="text-xs font-black text-slate-900 capitalize tracking-widest">Emergency Details</h3>
...
//               className="group flex items-center gap-2 bg-white hover:bg-white disabled:bg-slate-200 text-blue-500 font-black text-[10px] capitalize tracking-[0.15em] px-8 py-3 rounded-xl transition-all active:scale-95 shadow-sm shadow-blue-100"
//             >
//               {isSubmitting ? (
...
// // 🚀 MINIMIZED STYLES
// const labelStyle = "block text-[9px] font-black text-slate-400 capitalize tracking-[0.1em] mb-1.5 ml-1";
// const inputStyle = "w-full pl-9 pr-3 py-2.5 bg-white border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all text-[12px] font-bold text-slate-700 disabled:bg-slate-50 disabled:text-slate-400 placeholder:text-slate-300 shadow-sm";
// const iconStyle = "absolute left-3 top-1/2 -translate-y-1/2 text-slate-300 w-3.5 h-3.5 group-focus-within:text-blue-500 transition-colors";
