...
export default function EmployeeDemoDetails1() {
  const { id } = useParams();
...
<div className="border border-slate-200 rounded-[2rem] overflow-hidden bg-white shadow-sm transition-all hover:shadow-md">
  {/* Accordion Trigger */}
  <button
            ...
            {kyc?.pan_status === "verified" && (
              <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-8 p-10 bg-emerald-50 border border-emerald-100 rounded-[2.5rem] relative overflow-hidden animate-in fade-in zoom-in-95">
                ...
                <div className="space-y-6 flex-1 relative z-10">
                  <div>
                    <p className="text-[10px] uppercase tracking-[0.2em] text-emerald-600 font-black mb-1.5">Verification Signature</p>
                    <p className="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-none">Record Authenticated</p>
                  </div>
  ...
  >
    <div className="flex items-center gap-4">
      ...
      <div className="text-left">
        ...
        <div className="flex items-center gap-2">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Index: </p>
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8 p-6 bg-emerald-50/30 border border-emerald-100 rounded-[2.5rem] animate-in zoom-in-95">
              <div className="space-y-6 flex-1 text-center md:text-left">
                <div className="space-y-1">
                  ...
                  <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tighter">Settlement Node Verified</h3>
                </div>
        ...
        <div className="relative z-10 space-y-10">
          ...
          {!aadhaarSaved && (
            <div className="space-y-4 animate-in fade-in duration-500">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-1 h-4 bg-blue-600 rounded-full" />
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Primary Identification Number</label>
              </div>
              <div className="flex flex-col md:flex-row gap-4">
                <div className="relative group flex-1">
                  <Hash className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-blue-600 transition-colors" size={16} />
              ...
              <div className="flex flex-col lg:flex-row gap-10 items-start">
                ...
                <div className="flex-1 w-full space-y-8">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      {verifyingAadhaar ? "Executing Audit..." : "Execute Final Authorization"}
                    </button>
          ...
          {kyc?.aadhaar_status === "verified" && (
            <div className="flex flex-col md:flex-row justify-between items-center gap-10 p-10 bg-emerald-50/50 border border-emerald-100 rounded-[2.5rem] relative overflow-hidden animate-in zoom-in-95">
              ...
              <div className="space-y-6 flex-1 relative z-10">
                <div>
                  <p className="text-[10px] uppercase tracking-[0.2em] text-emerald-600 font-black mb-1.5">Authorized Signature</p>
                  <p className="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-none">Identity Fully Verified</p>
                </div>
                
                <div className="grid grid-cols-2 gap-10 pt-6 border-t border-emerald-200/50">
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Registry ID</p>
                    <p className="text-sm font-bold text-slate-700">#{kyc.aadhaar_verification_id}</p>
                  </div>
                  <div>
