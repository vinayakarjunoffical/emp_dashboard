...
// export default SalaryStructureTemplate;
// create salary struture code is above


//****************************************working code phase 1 24/03/26************************************************************* */
// import React, { useState, useEffect } from "react";
// import {
//   ArrowLeft,
//   ChevronDown,
...
//   // 🚀 PT SLABS STATE (Default 1 Row)
//   const [ptSlabs, setPtSlabs] = useState([
//     { id: 1, min: "0", max: "", tax: "0" },
//   ]);
...
//       hasInfo: true,
//     },
//     { id: 2, label: "Employee State Insurance (ESI)" },
//     { id: 3, label: "Professional Tax (PT)" },
//   ]);
//   const [employerContributions, setEmployerContributions] = useState([
//     { id: 1, label: "Provident Fund (PF)", amount: "" },
...
//       })),
//       ...deductions.map((item) => {
//         if (item.label === "Provident Fund (PF)") {
//           return {
//             name: item.label,
//             component_type: "deduction",
//             percentage_of_ctc:
//               pfCalcType === "Variable" ? parseFloat(pfVariablePercent) : null,
//             fixed_annual_value:
//               pfCalcType === "Fixed"
//                 ? parseFloat(pfFixedAmount.replace(/,/g, ""))
//                 : null,
//           };
//         }
//         return {
//           name: item.label,
//           component_type: "deduction",
//           percentage_of_ctc: null,
//           fixed_annual_value: 0,
//         };
//       }),
//       ...employerContributions.map((item) => ({
//         name: item.label,
...
//         <button
//           onClick={() => navigate(-1)}
//           className="flex !bg-transparent items-center gap-2 text-slate-400 hover:text-blue-600 border-0 bg-transparent cursor-pointer group"
//         >
//           <ArrowLeft
//             size={18}
//             className="group-hover:-translate-x-1 text-slate-300 transition-transform"
//           />
//           <span className="text-[11px] font-black uppercase !text-slate-400 tracking-widest leading-none">
//             Back to Templates
//           </span>
//         </button>
//       </div>
...
//                 value={templateName}
//                 onChange={(e) => setTemplateName(e.target.value)}
//                 className="w-full bg-slate-50 border border-slate-100 rounded-xl px-5 py-3.5 text-[11px] font-bold text-slate-700 outline-none focus:border-blue-400"
//               />
//             </div>
//             <div className="flex items-center gap-3 pt-6">
//               <input
...
//                   value={staffType}
//                   onChange={(e) => setStaffType(e.target.value)}
//                   className="w-full bg-slate-50 border border-slate-100 rounded-xl px-5 py-3.5 text-[11px] font-bold text-slate-700 appearance-none outline-none focus:border-blue-400 cursor-pointer"
//                 >
//                   <option>Monthly Regular</option>
//                   <option>Hourly</option>
//                 </select>
...
//                         )
//                       }
//                       className="w-full bg-slate-50 border border-slate-100 rounded-lg pl-4 pr-10 py-2.5 text-[11px] font-bold text-slate-700 outline-none focus:border-blue-400"
//                     />
...
//                         >
//                           <p className="text-[10px] sm:text-[11px] font-medium text-slate-500 italic mb-1 sm:mb-0 mr-2">
//                             If monthly payable salary is
//                           </p>
...
//                                 readOnly={index !== 0}
//                                 className={`w-full pl-7 pr-3 py-2 bg-white sm:bg-slate-50 border border-slate-200 sm:border-slate-200 rounded-lg text-[11px] font-bold text-slate-600 outline-none focus:border-blue-400 ${
//                                   index !== 0
...
//                                 )
//                               }
//                               className="p-1.5 !text-slate-400 hover:!text-slate-900 !bg-white sm:!bg-transparent border border-slate-200 sm:border-0 rounded-lg shrink-0 transition-colors cursor-pointer"
//                             >
//                               <MoreVertical size={16} />
//                             </button>
...
//                                     className="w-full text-left px-3 py-2 text-[10px] font-black text-slate-600 hover:bg-slate-50 hover:text-blue-600 rounded-lg transition-colors uppercase tracking-widest cursor-pointer"
//                                   >
//                                     Add Row
//                                   </button>
//                                   <button
...
//                                     className="w-full text-left px-3 py-2 text-[10px] font-black text-rose-500 hover:bg-rose-50 hover:text-rose-600 rounded-lg transition-colors uppercase tracking-widest disabled:opacity-50 disabled:cursor-not-allowed mt-0.5"
//                                   >
//                                     Delete Row
//                                   </button>
//                                 </div>
...
//           <button
//             onClick={() => navigate(-1)}
//             className="px-10 py-3 !bg-white border !border-slate-200 !text-slate-500 rounded-xl text-[11px] font-black uppercase tracking-widest hover:bg-slate-50 cursor-pointer"
//           >
//             Cancel
//           </button>
//           <button
//             disabled={isSubmitting}
//             onClick={handleSaveTemplate}
//             className={`px-16 py-3 border rounded-xl text-[11px] font-black uppercase tracking-widest shadow-sm transition-all cursor-pointer ${
//               isSubmitting
...
//                 </div>
//                 <div className="px-6 py-4 space-y-6">
//                   <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] border-b border-slate-50 pb-2 mb-4">
//                     Suggested
//                   </h4>
//                   <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
//                     {modal.list.map((item, index) => (
...
//                           className="w-4 h-4 rounded mr-3 border-slate-200 text-blue-600 focus:ring-0"
//                         />
//                         <span className="text-[11px] font-bold text-slate-600 uppercase tracking-tight group-hover:text-blue-600 transition-colors">
//                           {item.label}
//                         </span>
//                       </label>
//                     ))}
