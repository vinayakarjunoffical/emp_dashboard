...
import { 
  ArrowLeft, Plus, MoreVertical, Clock, Users, ShieldCheck, 
  ChevronRight, X, Search, Filter, User, ChevronUp, Loader2 
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-white font-sans pb-10 relative overflow-x-hidden text-left">
      ...
      <div className="bg-white border-b border-slate-100 px-4 py-2 flex items-center justify-between sticky top-0 z-30 shadow-sm">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate(-1)} className="p-1.5 !bg-transparent hover:!bg-slate-50 rounded-xl !text-slate-600 transition-all border-0 cursor-pointer">
            <ArrowLeft size={18} />
          </button>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-4 px-2">
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="md:text-xl text-lg font-black !text-slate-800 tracking-tighter !capitalize leading-none">Shift Templates</h1>
                <p className="md:text-[10px] text-[8px] font-bold !text-slate-400 capitalize tracking-[0.15em] mt-1">Add relevant shift templates for your business.</p>
              </div>
            </div>
          </div>
          <button 
            onClick={() => navigate('/createnewtemplate')}
            className="group flex items-center justify-center gap-2 px-6 py-2.5 border !border-blue-600 !bg-white !text-blue-600 rounded-xl shadow-sm hover:!bg-white transition-all active:scale-95 cursor-pointer">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between relative z-10 gap-4 sm:gap-0">
                  ...
                  <div className="flex items-start sm:items-center gap-4 w-full sm:w-auto">
                    <div className={`w-1 h-10 shrink-0 rounded-full transition-colors ${activeMenu === shift.id ? "bg-blue-600" : "bg-slate-100 group-hover:bg-blue-600"}`} />
                    <div className="space-y-1 w-full flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="relative sm:hidden block">
                          <button onClick={(e) => { e.stopPropagation(); setActiveMenu(activeMenu === shift.id ? null : shift.id); }} className={`p-2 rounded-xl transition-all !bg-transparent border-0 outline-none ${activeMenu === shift.id ? "!text-blue-600 !bg-blue-50" : "!text-slate-300"}`}>
                      ...
                      <div className="flex items-center gap-2 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-100 w-max">
                        ...
                        <span className="text-[10px] font-bold text-slate-500 capitalize tracking-tight">
                          Time: <span className="text-slate-800">{formatTime(shift.start_time)} - {formatTime(shift.end_time)}</span>
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto mt-2 sm:mt-0 pl-5 sm:pl-0 border-t border-slate-100 sm:border-0 pt-3 sm:pt-0">
                    ...
                    <div className="relative hidden sm:block">
                      <button onClick={(e) => { e.stopPropagation(); setActiveMenu(activeMenu === shift.id ? null : shift.id); }} className={`p-2 rounded-xl transition-all !bg-transparent border-0 outline-none ${activeMenu === shift.id ? "!text-blue-600 !bg-blue-50" : "!text-slate-300 hover:!text-slate-900"}`}>
                        <MoreVertical size={18} />
                      </button>
...
// import { 
//   ArrowLeft, Plus, MoreVertical, Clock, Users, ShieldCheck, 
//   ChevronRight, X, Search, Filter, User, ChevronUp 
// } from 'lucide-react';
// import { useNavigate } from 'react-router-dom';
...
//       {/* 🚀 STICKY HEADER */}
//       <div className="bg-white border-b border-slate-100 px-4 py-2 flex items-center justify-between sticky top-0 z-30 shadow-sm shadow-slate-200/50">
//         <div className="flex items-center gap-3">
//           <button 
//             onClick={() => navigate(-1)}
//             className="p-1.5 hover:!bg-slate-50 rounded-xl !bg-transparent !text-slate-400 border !border-transparent hover:!border-slate-100 transition-all"
//           >
//             <ArrowLeft size={18} />
//           </button>
//           <span className="text-[10px] font-black text-slate-900 capitalize tracking-widest">Settings / Shifts</span>
...
//         {/* 📂 SHIFT CARDS LIST - Minimal Spacing Logic */}
//         <div className="grid grid-cols-1 gap-2">
//           {shifts.map((shift) => (
//             <div 
//               key={shift.id} 
//               className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm hover:shadow-md hover:border-blue-400 transition-all group relative overflow-hidden cursor-pointer"
//             >
//               {/* Subtle Branding Background Icon */}
//               <div className="absolute -bottom-4 -right-4 text-slate-100 opacity-[0.4] group-hover:text-blue-50 transition-colors -rotate-12">
//                 <ShieldCheck size={100} />
//               </div>
...
//                   <button className="p-2 !text-slate-300 !bg-transparent hover:!text-slate-900 hover:!bg-slate-50 rounded-xl transition-all">
//                     <MoreVertical size={18} />
//                   </button>
//                 </div>
//               </div>
