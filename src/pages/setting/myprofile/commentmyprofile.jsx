...
//   const ProfileItem = ({ label, value, badge, children }) => (
//     <div className="py-3 flex flex-col gap-1 group transition-all duration-200">
//       <label className="text-[9px] font-black text-slate-400 capitalize tracking-[0.2em] leading-none">
//         {label}
//       </label>
//       <div className="flex items-center gap-2">
//         {children ? children : (
...
//               <div className="space-y-0.5">
//                 <h1 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tighter capitalize leading-none">Organization Profile</h1>
//                 <p className="text-[9px] font-bold text-slate-400 capitalize tracking-[0.3em]">ID: ENT-9825-GTPL</p>
//               </div>
//            </div>
...
//                 <ProfileItem label="Contact Number" value={profileData.phone} />
//                 <ProfileItem label="Email" value={profileData.email} badge={<div className="flex items-center gap-1 bg-emerald-50 text-emerald-600 px-2 py-0.5 rounded-md border border-emerald-100/50"><CheckCircle2 size={8} strokeWidth={4} /><span className="text-[7px] font-black capitalize">Verified</span></div>} />
//                 <ProfileItem label="Business (State & City)" value={profileData.jurisdiction} />
//                 <ProfileItem label="Business Address" value={profileData.address} />
//               </div>
//             </div>
...
//               <div className="space-y-0.5">
//                 <h2 className="text-xl font-black text-slate-900 capitalize tracking-tighter leading-none">
//                   Manage Documents
//                 </h2>
...
//                       type="button"
//                       onClick={() => fileInputRef.current.click()}
//                       className="flex items-center gap-2 px-4 py-2 !bg-white border !border-slate-200 !text-blue-600 rounded-xl text-[10px] font-black capitalize tracking-widest hover:!bg-blue-50 transition-all cursor-pointer"
//                     >
//                       <ImagePlus size={14} /> Upload Logo
//                     </button>
//                     <p className="text-[8px] font-bold text-slate-400 capitalize ml-1">
//                       PNG, JPG or SVG (Max 2MB)
//                     </p>
//                   </div>
//                 </div>
...
//                   </div>
//                 ) : (
//                   <div className="h-64 w-full bg-slate-100 rounded-2xl flex items-center justify-center text-[10px] font-black text-slate-400 capitalize tracking-widest animate-pulse border border-slate-200">
//                     Loading Map Engine...
//                   </div>
//                 )}
...
//               {/* Logo Upload Box */}
//               {/* <div className="md:col-span-2 flex flex-col gap-2">
//                  <label className="text-[9px] font-black text-slate-400 capitalize tracking-widest ml-1">Business Logo</label>
//                  <div className="flex items-center gap-6 bg-slate-50/50 p-4 rounded-2xl border border-slate-100">
...
//                        <img src={profileData.logoUrl} className="w-full h-full object-cover" alt="Preview" />
//                     </div>
//                     <button className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 text-blue-600 rounded-xl text-[10px] font-black capitalize tracking-widest hover:bg-white shadow-sm cursor-pointer">
...
//               <div className="space-y-2">
//                 <label className="text-[9px] font-black text-slate-400 capitalize tracking-widest ml-1">Business (State & City)</label>
...
//               <div className="md:col-span-2 space-y-2">
//                 <label className="text-[9px] font-black text-slate-400 capitalize tracking-widest ml-1">Business Address</label>
...
//           </div>
//           <span className="text-[10px] font-black capitalize text-slate-400 tracking-[0.15em]">Back</span>
//         </button>
        
//         <div className="flex items-center gap-2 px-3 py-1 bg-emerald-50 rounded-md border border-emerald-100/50">
//            <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
//            <span className="text-[8px] font-black text-emerald-700 capitalize tracking-widest pt-0.5">Live Sync</span>
//         </div>
//       </div>
...
//                   <LayoutGrid size={20} />
//                </div>
//                <p className="text-[9px] font-black text-slate-300 capitalize tracking-[0.25em]">No additional modules detected</p>
//             </div>
//           </div>
...
//                       <span className="text-[7px] font-black capitalize">Verified</span>
//                     </div>
//                   }
//                 />
...
//                    <p className="text-[10px] font-black text-slate-800 capitalize tracking-widest leading-none">Support</p>
//                    <p className="text-[8px] font-bold text-slate-400 capitalize tracking-widest">Direct Ticket</p>
//                 </div>
//             </button>
//           </div>
