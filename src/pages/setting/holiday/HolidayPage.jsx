    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-10 relative overflow-x-hidden text-left">
      ...
      <div className="bg-white border-b border-slate-100 px-4 py-3 flex items-center justify-between sticky top-0 z-30 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none">Settings / Holiday Templates</span>
        </div>
      </div>
      ...
      <div className=" mx-auto md:px-6 px-2 mt-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <div className="space-y-1 px-2">
            <h1 className="md:text-xl text-lg font-black text-slate-900 tracking-tighter uppercase">Holiday Templates</h1>
            <p className="md:text-[10px] text-[8px] font-bold text-slate-400 uppercase tracking-widest">Create templates to auto-assign paid leave on public holidays.</p>
          </div>
          <button 
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-0">
        ...
        <div className="flex items-center gap-4 sm:gap-5">
          ...
          <div className="space-y-1">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="px-2 py-0.5 bg-blue-50 text-blue-600 text-[8px] font-black rounded-md uppercase tracking-tighter border border-blue-100 whitespace-nowrap">
                {item.status}
              </span>
            </div>
        ...
        <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-4 sm:gap-8 border-t border-slate-100 sm:border-t-0 pt-3 sm:pt-0">
          ...
          >
            <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1 group-hover/staff:text-blue-500 transition-colors">
              Assigned Staff
            </p>
