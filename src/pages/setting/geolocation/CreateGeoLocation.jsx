          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex flex-wrap items-end gap-4">
              <div className="flex-1 min-w-[300px]">
                <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1 block">Template Name <span className="text-red-500">*</span></label>
                <input 
                  type="text" 
              ...
              <div className="flex items-center gap-2 pb-2">
                ...
                <label htmlFor="approval" className="text-[11px] font-bold text-slate-600 cursor-pointer">Approval Required?</label>
            ...
            <div className="space-y-3">
              <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Sites List</h3>
                ...
                <div key={site.id} className="border border-slate-100 rounded-xl overflow-hidden shadow-sm">
                  ...
                  <div className="bg-slate-50/50 px-4 py-2 flex items-center justify-between border-b border-slate-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[11px] font-black text-slate-700 uppercase leading-none">{site.siteName || 'Untitled Site'}</p>
                        <p className="text-[9px] font-bold text-slate-400 uppercase tracking-tighter">Radius: {site.radius || '-'}m</p>
                      </div>
                    </div>
                  ...
                  <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <div>
                        <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1 block">Site Name <span className="text-red-500">*</span></label>
                        <input 
                          type="text" 
  ...
  <div className="relative">
    ...
    {isLoaded ? (
      ...
      />
                      ...
                      <div>
                        <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1 block">Radius (in meters) <span className="text-red-500">*</span></label>
                        <input 
                          type="number" 
                    ...
                    <div className="h-48 bg-slate-100 rounded-xl border border-slate-200 relative overflow-hidden group">
                      {isLoaded ? (
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-200/50 backdrop-blur-[1px]">
                             ...
                             <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Loading Google Maps...</span>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-widest">Add Site</span>
              </button>
            </div>
          </div>
        </div>
